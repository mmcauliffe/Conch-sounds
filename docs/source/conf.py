...
# -*- coding: utf-8 -*-
#
# Conch documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'Conch.tex', 'Conch Documentation',
...
man_pages = [
    (master_doc, 'conch', 'Conch Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Conch', 'Conch Documentation',
     author, 'Conch', 'One line description of project.',
     'Miscellaneous'),
]
